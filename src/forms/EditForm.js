        ...
        return(
            <div className="alertForm">
                ...
                <div className="noteCategoryEdit">
                    ...
                    <input type="text" id="editCategory" list="categoryList" defaultValue={noteList[index].category} style={{border:'none'}} onChange={(e)=>this.onChange(e)}/>
                ...
                <div className="noteContentEdit">
                    ...
                    <textarea id="editContent" defaultValue={noteList[index].content} style={{border:'none'}} onChange={(e)=>this.onChange(e)}/>
                </div>
