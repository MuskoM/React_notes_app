...
export default class RemindForm extends Component {
    constructor(props){
        super(props);
        this.state={
    ...
    render() {
        ...
        return (
            ...
            <div className="ImportantInfoAlert">
                <Icon.Bell size ={80} color ="#999900" className="item"/>
                Remind
            </div>
            <div>
                ...
                <div className="remindOption">
                    <span>Tomorrow at:</span>
                    <span className="remindTime">
                        <input type="time" defaultValue={actualTime} id="time" onChange={(e)=>this.onChange(e,'tommorow')}/>
                    </span>
                </div>
                <div className="remindOption">
                    <span>Day after tomorrow at:</span>
                    <span className="remindTime">
                        <input type="time" defaultValue={actualTime} id="time" onChange={(e)=>this.onChange(e,'dayAfterTomorrow')}/>
                    </span>
                </div>
                <div className="remindOption">
                ...
                <div className="remindOption">
                    <span><input type="date" id="date" onChange={(e)=>this.onChange(e,"")}/> at:</span>
                    <span className="remindTime">
